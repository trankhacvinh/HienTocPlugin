...
$tables = [
    ...
    $wpdb->prefix . 'htp_submissions',
    $wpdb->prefix . 'htp_form_fields',
    $wpdb->prefix . 'htp_forms',
...
$options = [
    ...
    'htp_oa_button_label',
    'htp_upload_max_mb',
    'htp_hair_photo_limit',
    'htp_duplicate_days',
    'htp_privacy_text',
    'htp_member_success_text',
    'htp_donation_success_text',
...
$wpdb->query("DELETE FROM {$wpdb->options}
    WHERE option_name LIKE '_transient_htp_rate_%'
       OR option_name LIKE '_transient_timeout_htp_rate_%'
       OR option_name LIKE '_transient_htp_visit_%'
       OR option_name LIKE '_transient_timeout_htp_visit_%'"); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared
