                ...
                <section class="htp-panel">
                    ...
                    <form method="post" action="options.php">
                        ...
                        <table class="form-table" role="presentation">
                            <tr><th>Trạng thái</th><td><label><input type="hidden" name="htp_google_sheets_enabled" value="0"><input type="checkbox" name="htp_google_sheets_enabled" value="1" <?php checked((int) get_option('htp_google_sheets_enabled', 0), 1); ?>> Bật đồng bộ Google Sheets</label></td></tr>
